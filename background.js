...
/*
code to scrape components from library:
var li = document.getElementsByClassName('slds-tree__item-label');
var names = new Array();for(var i = 0; i < li.length; i++){names.push(li[i].innerHTML);}
document.getElementsByTagName('body')[0].innerHTML = names.join(",");
*/
